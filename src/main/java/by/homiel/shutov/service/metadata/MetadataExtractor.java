package by.homiel.shutov.service.metadata;

import by.homiel.shutov.config.ConfigDbConnection;
...
public class MetadataExtractor {
    ...
    private final ConfigDbConnection configDbConnection;
    ...
    public Map<String, List<String>> getMetaData() {
        ...
        try (Connection conn = configDbConnection.createDbConnection()) {
